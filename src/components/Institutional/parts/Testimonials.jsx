  ...
  return (
    <section className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl lg:max-w-4xl">
        <img className="mx-auto h-36" src="/src/assets/img/logo.PNG" alt="" />
        <figure className="mt-10">
          <blockquote className="text-center text-xl font-semibold leading-8 text-gray-900 sm:text-2xl sm:leading-9">
            <p>
              “Nuestra institución nace como una propuesta educativa diferente dentro de la ciudad de Fernández, y buscamos que nuestros alumnos generen competencias técnicas específicas mediante las cuales sean capaces de desempeñarse en un campo laboral cada vez mas exigente.”
            </p>
          </blockquote>
