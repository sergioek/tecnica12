    ...
    <div>
      <div className="border-b border-gray-300">
        ...
        <p className="mt-1 text-lg leading-8 text-gray-600">
          Los inicios como institución educativa del nivel secundario.
        </p>
      </div>
      ...
      <div className="my-12 flex flex-col-reverse gap-12 items-center lg:flex-row-reverse">
        ...
        <p className="text-gray-600 text-md leading-6 text-justify font-sans">
          ...
          y de nuestro país. Cuenta con su Planta Funcional Directiva, Docente y
          Administrativa completa y participa activamente de diferentes
          proyectos institucionales y de la comunidad. Gran parte del personal
          está integrado por docentes que son nativos de la ciudad de Fernández,
          muchos de los cuales son técnicos egresados de la Escuela Piloto
          Maximio S. Victoria, por lo cual existe un alto sentido de pertenencia
          con la Escuela Técnica Nº12, lo que incrementa el compromiso con las
          actividades que incluso exceden a la función misma de cada persona.
        </p>
      </div>
    </div>
  );
